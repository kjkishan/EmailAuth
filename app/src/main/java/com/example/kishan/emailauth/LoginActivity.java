...
public class LoginActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //for checking the condition is user is login or not:
        if (LoginAuth.getCurrentUser() != null) {
            startActivity(new Intent(LoginActivity.this, MainActivity.class));
             finish();
        }
        //Setting the OnClickListener with the for Registration activity:
        ...
        logi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String e,p;
                e=emal.getText().toString().trim();
                p=passl.getText().toString().trim();

                if (!e.isEmpty() && !p.isEmpty())
                {
                    LoginAuth.signInWithEmailAndPassword(e,p).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
